...
export default function POSPage() {
  ...
  const crearVentaMutation = useMutation({
    mutationFn: async () => {
      ...
      const payload = {
        ...
        items: items.map((item) => ({
          ...
          descuento: (item.precioUnitario * item.cantidad * item.descuentoItem) / 100,
        })),
      };
    ...
    onError: async (error) => {
      ...
      const payload = {
        ...
        montoPagado: totales.total,
        notas: observaciones || undefined,
        items: items.map((i) => ({ varianteId: i.varianteId, cantidad: i.cantidad, descuento: 0 })),
      };
  ...
  const imprimirTicket = async () => {
    ...
    a.href = url;
    a.download = `ticket-${ultimaVentaId}.txt`;
    a.click();
          ...
          <div className="mb-6 flex flex-col gap-3 sm:flex-row">
            <div className="relative flex-1">
              ...
              <ScanBarcode
                ...
                style={{ color: S.secondary, opacity: 0.6 }}
              />
            </div>
            <button
              type="button"
